...
public class TestHelpers {
    ...
    public static void LogSolution(Vector3 position, Vector3 velocity, string fn1="ExpectedPosition", string fn2="ExpectedVelocity")
    {
        Debug.Log(string.Format(".{5}(new Vector3({0:0.00000}f, {1:0.00000}f, {2:0.00000}f))\n.{6}(new Vector3({3:0.00000}f, {4:0.00000}, {7:0.00000}f))",
